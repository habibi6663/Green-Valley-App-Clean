        ...
        {isModalOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-surface-container-low border border-outline-variant/10 rounded-3xl p-8 shadow-2xl z-[201] space-y-8 max-h-[90vh] overflow-y-auto"
            >
              ...
              <form className="space-y-6" onSubmit={(e) => {
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button 
                    type="submit"
                    disabled={isUploading}
                    className="py-4 bg-brand-green text-surface rounded-2xl font-bold text-[10px] uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-brand-green/20 flex items-center justify-center gap-2 disabled:opacity-50"
                  >
                    {isUploading ? (
                      <>
