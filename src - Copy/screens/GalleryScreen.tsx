        ...
        <section className="bg-surface-container-low rounded-3xl border border-outline-variant/10 p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_auto] gap-4">
            ...
            <button
              ...
              disabled={uploading}
              className="rounded-full bg-brand-green px-6 py-3 text-xs font-bold uppercase tracking-widest text-surface transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-60"
            >
