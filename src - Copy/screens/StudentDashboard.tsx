    ...
    <div className="space-y-16">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
        ...
        <div 
          ...
          className="w-full md:w-auto bg-surface-container-high rounded-2xl p-6 flex items-center gap-6 border border-outline-variant/10 hover:border-brand-green/30 transition-all cursor-pointer group"
        >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Attendance Card */}
        <div className="bg-surface-container-low rounded-2xl p-8 border border-outline-variant/5 flex flex-col justify-between">
        ...
        {/* Latest Notes */}
        <div className="md:col-span-2 bg-surface-container-low rounded-2xl p-8 border border-outline-variant/5 flex flex-col md:flex-row gap-8 items-center">
            ...
            assignments.map((assignment) => {
              ...
              return (
                <div 
                  key={assignment.id} 
                  onClick={onViewAssignments}
                  className="group bg-surface-container-low hover:bg-surface-container-high transition-all rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 border border-outline-variant/5 cursor-pointer"
                >
                  <div className="flex items-center gap-5">
                    <div className="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center text-brand-green group-hover:scale-110 transition-transform">
                      <Icon size={24} />
                    </div>
                    <div>
