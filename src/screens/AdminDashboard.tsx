    ...
    <div className="space-y-12 pb-24 relative">
        ...
        {isModalOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl bg-surface-container-low border border-outline-variant/10 rounded-3xl p-4 md:p-8 shadow-2xl z-[101] overflow-hidden"
            >
              {success ? (
                ...
                <div className="space-y-8">
                  ...
                  <form onSubmit={editingUser ? handleUpdate : handleRegister} className="space-y-6">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      {formData.role === 'TEACHER' && (
                        ...
                        >
                          ...
                          <div className="bg-surface-container-high border border-outline-variant/10 rounded-xl p-4 gap-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:grid-cols-4 max-h-48 overflow-y-auto">
                            {VALID_CLASSES.map(cls => {
                    ...
                    <button 
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full py-4 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-2xl font-bold text-xs uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-brand-green/10 flex items-center justify-center gap-3 disabled:opacity-70 disabled:grayscale"
                    >
                      {isSubmitting ? (
        ...
        {confirmDeleteUser && (
          <>
            ...
            <motion.div 
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-sm bg-surface-container-low border border-outline-variant/10 rounded-3xl p-4 md:p-8 shadow-2xl z-[201] text-center space-y-6"
            >
              <div className="w-12 h-12 md:w-16 md:h-16 bg-error/10 text-error rounded-full flex items-center justify-center mx-auto">
      ...
      <section className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          ...
          <div className="flex gap-4">
            <div className="bg-surface-container-low rounded-2xl p-4 md:p-6 border border-outline-variant/5 min-w-[200px]">
              ...
              <span className="text-xl md:text-3xl font-bold text-white">{totalUsers}</span>
            </div>

            <div className="bg-surface-container-low rounded-2xl p-4 md:p-6 border border-outline-variant/5 min-w-[160px]">
              <div className="flex justify-between items-baseline mb-2">
              ...
              <span className="text-xl md:text-3xl font-bold text-white">{totalStudents}</span>
            </div>

            <div 
              onClick={onViewNotes}
              className="bg-surface-container-low rounded-2xl p-4 md:p-6 border border-outline-variant/5 min-w-[160px] hover:border-brand-green/30 transition-all cursor-pointer group"
            >
              <div className="flex justify-between items-baseline mb-2">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xl md:text-3xl font-bold text-white tracking-tighter">Vault.</span>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-3 pr-2 border-r border-outline-variant/10 mr-1">
                    <button 
                      ...
                      className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center bg-surface-container-high text-outline hover:text-brand-green hover:bg-brand-green/10 transition-all"
                    >
                      <Pencil size={14} />
                    </button>
                    {(user.role || '').toUpperCase() !== 'ADMIN' && (
                      <button 
                        ...
                        className="w-8 h-8 md:w-10 md:h-10 rounded-lg flex items-center justify-center bg-surface-container-high text-outline hover:text-error hover:bg-error/10 transition-all"
                      >
                        <Trash2 size={14} />
                      </button>
                    )}
      ...
      <div className="fixed bottom-24 right-8 z-[50]">
        <button 
          ...
          className="flex items-center gap-3 px-8 py-4 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-full shadow-2xl hover:scale-105 active:scale-95 transition-all"
        >
          <UserPlus size={18} />
