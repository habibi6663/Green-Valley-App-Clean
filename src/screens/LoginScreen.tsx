...
export default function LoginScreen({ onLogin, errorMessage = null }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-6 md:p-12">
      <main className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <section className="lg:col-span-5 flex flex-col space-y-8">
          <div className="flex items-center space-x-4">
            <img src="/logo.png" alt="Green Valley Logo" className="w-12 h-12 md:w-16 md:h-16 object-contain drop-shadow-xl" onError={() => console.log("Logo failed to load")} />
            <div className="flex flex-col">
              <h1 className="font-headline font-extrabold text-xl md:text-3xl tracking-tight text-white leading-none mb-1">
        ...
        <section className="lg:col-span-7 lg:pl-12">
          <motion.div
            ...
            className="glass-panel p-4 md:p-8 md:p-12 rounded-lg shadow-[0px_24px_48px_rgba(0,0,0,0.4)]"
          >
            <div className="flex gap-4 mb-4 md:mb-8 p-1 bg-surface-container-low rounded-full border border-outline-variant/10">
              <button
