        ...
        <main className="flex-1 flex flex-col">
          ...
          <footer className="p-4 md:p-6">
            ...
            >
              ...
              <button 
                type="submit"
                className="w-10 h-10 rounded-xl bg-brand-green w-full md:w-auto min-h-[44px] flex items-center justify-center text-surface hover:opacity-90 active:scale-95 transition-all"
              >
                <Send size={18} />
              </button>
            </form>
