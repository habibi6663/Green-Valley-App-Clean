...
export default function ParentDashboard({ 
  ...
  return (
    <div className="space-y-16">
      ...
      <section 
        onClick={onViewNotes}
        className="bg-surface-container-low rounded-3xl p-4 md:p-8 border border-outline-variant/10 hover:border-brand-green/30 transition-all cursor-pointer group relative overflow-hidden"
      >
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-brand-green/10 flex items-center justify-center text-brand-green">
              <FileText size={32} />
            </div>
          ...
          <button className="flex items-center gap-3 px-8 py-4 bg-surface-container-high text-white rounded-full font-bold text-xs uppercase tracking-widest hover:bg-brand-green w-full md:w-auto min-h-[44px] hover:text-surface transition-all group-hover:scale-105 active:scale-95">
            Open Registry
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        {/* Fee Payment Card */}
        <div className="md:col-span-4 bg-surface-container-high rounded-2xl p-4 md:p-8 border border-outline-variant/10 flex flex-col justify-between min-h-[300px]">
          <div>
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-brand-green/10 flex items-center justify-center text-brand-green mb-6">
              <Wallet size={24} />
            </div>
          ...
          <button 
            disabled
            className="w-full py-4 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-full font-bold text-xs uppercase tracking-widest opacity-50 cursor-not-allowed mt-8"
          >
            Pay (Coming Soon)
          </button>
        </div>
        ...
        <div className="md:col-span-8 bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5 flex flex-col justify-between min-h-[300px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div 
          ...
          className="md:col-span-4 bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5 flex flex-col items-center justify-center cursor-pointer hover:border-brand-green/30 transition-all group"
        >
        ...
        {/* Recent Updates */}
        <div className="md:col-span-8 bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5">
          <div className="flex justify-between items-center mb-4 md:mb-8 border-b border-outline-variant/10 pb-4">
      ...
      <div className="fixed bottom-24 right-6 md:bottom-12 md:right-12 z-40">
        <button 
          ...
          className="w-14 h-14 rounded-full bg-brand-green w-full md:w-auto min-h-[44px] text-surface shadow-2xl flex items-center justify-center group hover:scale-105 active:scale-90 transition-all"
        >
