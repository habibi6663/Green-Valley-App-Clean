    ...
    <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          <div className="space-y-2">
            <motion.h2 
              ...
              className="font-headline text-2xl md:text-4xl md:text-5xl font-bold tracking-tight text-brand-green"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5">
            <h3 className="font-bold text-lg text-white mb-4 md:mb-8 border-b border-outline-variant/10 pb-4">Secure Payment</h3>
            ...
            <form className="space-y-8" onSubmit={handlePayment}>
              ...
              <button 
                ...
                className="w-full py-5 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-full font-bold text-xs uppercase tracking-widest hover:opacity-90 active:scale-95 transition-all disabled:opacity-70 flex items-center justify-center gap-2 mt-8"
              >
