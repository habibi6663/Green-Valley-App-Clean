    ...
    <div className="space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <section className="lg:col-span-4">
          <div className="bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5 space-y-8">
            ...
            <form className="space-y-6" onSubmit={handleGenerate}>
              ...
              <button 
                ...
                className="w-full py-5 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-full font-bold text-xs uppercase tracking-widest hover:opacity-90 active:scale-95 transition-all disabled:opacity-70 flex items-center justify-center gap-3 mt-4"
              >
        ...
        <section className="lg:col-span-8">
          <div className="bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/5 min-h-[500px] flex flex-col">
