    ...
    <div className="space-y-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div 
          ...
          className="bg-surface-container-low rounded-2xl p-4 md:p-8 border border-outline-variant/10 hover:border-brand-green/30 transition-all cursor-pointer group flex flex-col justify-between min-h-[200px]"
        >
          <div className="flex justify-between items-start">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-brand-green/10 flex items-center justify-center text-brand-green">
              <UserCheck size={24} />
            </div>
