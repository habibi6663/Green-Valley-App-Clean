    ...
    <div className="space-y-16">
      ...
      <section className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
          ...
          <button
            onClick={onAddUser}
            className="px-8 py-4 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-full font-bold text-xs uppercase tracking-widest hover:opacity-90 active:scale-95 transition-all flex items-center gap-2"
          >
            <UserPlus size={18} />
            Add New User
          </button>
      ...
      {/* Filters & Search */}
      <section className="flex flex-col md:flex-row gap-6 justify-between items-center bg-surface-container-low p-4 md:p-6 rounded-2xl border border-outline-variant/5">
      ...
      {editingUser && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          ...
          >
            <div className="p-4 md:p-6 border-b border-outline-variant/5">
            ...
            <form onSubmit={handleUpdate} className="p-4 md:p-6 space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isUpdating}
                  className="flex-1 py-3 bg-brand-green w-full md:w-auto min-h-[44px] text-surface rounded-xl font-bold text-xs uppercase tracking-widest hover:opacity-90 transition-all disabled:opacity-50"
                >
